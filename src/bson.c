...
bool php_phongo_bson_visit_document(const bson_iter_t *iterARG_UNUSED, const char *key, const bson_t *v_document, void *data);
bool php_phongo_bson_visit_array(const bson_iter_t *iterARG_UNUSED, const char *key, const bson_t *v_document, void *data);
...
/* }}} */
#if 0
bool php_phongo_bson_visit_before(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
	return false;
}
/* }}} */
bool php_phongo_bson_visit_after(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
	return false;
}
/* }}} */
#endif
void php_phongo_bson_visit_corrupt(const bson_iter_t *iterARG_UNUSED, void *data) /* {{{ */
{
...
/* }}} */
bool php_phongo_bson_visit_double(const bson_iter_t *iterARG_UNUSED, const char *key, double v_double, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_utf8(const bson_iter_t *iterARG_UNUSED, const char *key, size_t v_utf8_len, const char *v_utf8, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_binary(const bson_iter_t *iterARG_UNUSED, const char *key, bson_subtype_t v_subtype, size_t v_binary_len, const uint8_t *v_binary, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
#if 0
bool php_phongo_bson_visit_undefined(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
...
bool php_phongo_bson_visit_oid(const bson_iter_t *iterARG_UNUSED, const char *key, const bson_oid_t *v_oid, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
bool php_phongo_bson_visit_bool(const bson_iter_t *iterARG_UNUSED, const char *key, bool v_bool, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_date_time(const bson_iter_t *iterARG_UNUSED, const char *key, int64_t msec_since_epoch, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
bool php_phongo_bson_visit_null(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_regex(const bson_iter_t *iterARG_UNUSED, const char *key, const char *v_regex, const char *v_options, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
#if 0
bool php_phongo_bson_visit_dbpointer(const bson_iter_t *iterARG_UNUSED, const char *key, size_t v_collection_len, const char *v_collection, const bson_oid_t *v_oid, void *data) /* {{{ */
{
	printf("Not Implemented\n");
...
/* }}} */
#endif
bool php_phongo_bson_visit_code(const bson_iter_t *iterARG_UNUSED, const char *key, size_t v_code_len, const char *v_code, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
#if 0
bool php_phongo_bson_visit_symbol(const bson_iter_t *iterARG_UNUSED, const char *key, size_t v_symbol_len, const char *v_symbol, void *data) /* {{{ */
{
	printf("Not Implemented\n");
...
/* }}} */
#endif
bool php_phongo_bson_visit_codewscope(const bson_iter_t *iterARG_UNUSED, const char *key, size_t v_code_len, const char *v_code, const bson_t *v_scope, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
bool php_phongo_bson_visit_int32(const bson_iter_t *iterARG_UNUSED, const char *key, int32_t v_int32, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_timestamp(const bson_iter_t *iterARG_UNUSED, const char *key, uint32_t v_timestamp, uint32_t v_increment, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
bool php_phongo_bson_visit_int64(const bson_iter_t *iterARG_UNUSED, const char *key, int64_t v_int64, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
...
/* }}} */
bool php_phongo_bson_visit_maxkey(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
/* }}} */
bool php_phongo_bson_visit_minkey(const bson_iter_t *iterARG_UNUSED, const char *key, void *data) /* {{{ */
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	zval *zchild = NULL;
	TSRMLS_FETCH();
...
bool php_phongo_bson_visit_array(const bson_iter_t *iterARG_UNUSED, const char *key, const bson_t *v_array, void *data)
{
	zval *retval = ((php_phongo_bson_state *)data)->zchild;
	bson_iter_t child;
	TSRMLS_FETCH();
